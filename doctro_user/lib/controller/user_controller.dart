...
import 'package:doctro_user/model/notification_model.dart';
...
class UserController extends ChangeNotifier {
  ...
  Future fetchNotifications(context) async {
    try {
      ...
      QuerySnapshot notiSnapshot = await notiRef.get();

      for (var doc in notiSnapshot.docs) {
        String notiID = doc['notiID'];
        String userID = doc['userID'];
        String doctorID = doc['doctorID'];
        String doctorName = doc['doctorName'];
        String bookingDate = doc['bookingDate'];
      ...
      print(e);
      ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('Fetching Notifications failed : $e')));
    }
  }
}
