...
import 'package:doctro_doctor/model/notification_model.dart';
...
class DoctorController extends ChangeNotifier {
  ...
  Future sendNotification(String userID, String doctorID, String bookingDate,
      String doctorName, context) async {
    try {
      ...
      await docRef.set(_notificationModel!.toMap());
      notifyListeners();
    } catch (e) {
      ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('Failed to send notofocation : $e')));
    }
  }
}
